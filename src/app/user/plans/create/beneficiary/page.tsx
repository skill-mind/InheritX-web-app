  ...
  return (
    <main className="flex flex-col gap-6 p-4 md:p-8 w-full min-h-screen bg-[#161E22]">
      ...
      <div className="w-full flex items-center justify-between mb-8">
        <div className="flex items-center w-full">
          ...
          <div className="flex-1 h-2 mx-2 rounded-full bg-[#232B36] relative">
            <div
              className="absolute top-0 left-0 h-2 rounded-full bg-[#33C5E0]"
      ...
      <div className="flex flex-row justify-between w-full mb-2">
        <span className={`text-cyan-400 text-[15px] font-medium ml-2`}>
          Beneficiary Details
        </span>
        <span className={`text-[#BFC6C8] text-[15px] font-medium mr-2`}>
          Verification
        </span>
      </div>
