...
export default function HowItWorksPage() {
	const [activeTab, setActiveTab] = useState<"plans" | "claims" | "kyc">("plans");
	...
	return (
			...
			<div className="max-w-[110rem] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 relative z-10">
				<div className="flex flex-col lg:flex-row gap-8">
					...
					<div className="flex-1">
						...
						<p className="text-[12px] md:text-[14px] text-[#92A5A8] max-w-2xl mb-6 reveal" data-step={1} style={{ transitionDelay: `160ms` }}>
							Follow these steps to get the most out of your digital inheritance
							platform.
						</p>

						{/* Tabs */}
						<div className="flex items-center gap-4 how-tabs mb-8 reveal" data-step={2} style={{ transitionDelay: `220ms` }}>
							<button
					...
					<div className="w-full lg:w-[320px] flex-shrink-0 reveal" data-step={999} style={{ transitionDelay: `260ms` }}>
						<div className="how-contact rounded-md p-6 flex items-center gap-3 text-[#92A5A8] text-[14px] justify-center reveal" data-step={1000} style={{ transitionDelay: `300ms` }}>
        ...
        .stagger-child { transition-property: opacity, transform; }
        .faqs-box.reveal, .how-contact.reveal { will-change: transform, opacity; }
        /* subtle hover for tab buttons */
        .how-tabs button[aria-selected="true"] { box-shadow: 0 10px 30px rgba(51,197,224,0.06); transform: translateY(-2px); }
      `}</style>
		</div>
	);
}
