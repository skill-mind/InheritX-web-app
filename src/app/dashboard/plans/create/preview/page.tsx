        ...
        <div className="flex flex-row items-center justify-between w-full mb-2">
          {[1, 2, 3, 4, 5].map((step, idx) => (
            <div key={step} className="flex flex-col items-center flex-1">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${step <= 5 ? "border-cyan-400 bg-[#161E22]" : "border-[#232B36] bg-[#232B36]"}`}
              >
                {step < 5 ? (
        ...
        <section className="flex flex-col gap-8 w-full max-w-3xl mx-auto">
          <div className="bg-[#161E22] border border-[#232B36] rounded-[18px] p-6 mb-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="flex items-center gap-2 text-[#33C5E0] border border-[#33C5E03D] px-4 py-2 rounded-[24px] text-[14px] hover:bg-[#33C5E0] hover:text-[#161E22]" onClick={handleEditPlan}>
          ...
          <div className="bg-[#161E22] border border-[#232B36] rounded-[18px] p-6 mb-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="flex items-center gap-2 text-[#33C5E0] border border-[#33C5E03D] px-4 py-2 rounded-[24px] text-[14px] hover:bg-[#33C5E0] hover:text-[#161E22]" onClick={handleEditAssets}>
                <Image src="/assets/icons/edit.svg" alt="edit" width={16} height={16} />
                Edit Assets
              </button>
            </div>
          ...
          <div className="bg-[#161E22] border border-[#232B36] rounded-[18px] p-6 mb-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="flex items-center gap-2 text-[#33C5E0] border border-[#33C5E03D] px-4 py-2 rounded-[24px] text-[14px] hover:bg-[#33C5E0] hover:text-[#161E22]" onClick={handleEditRules}>
                <Image src="/assets/icons/edit.svg" alt="edit" width={16} height={16} />
                Edit Rules
              </button>
            </div>
          ...
          <div className="bg-[#161E22] border border-[#232B36] rounded-[18px] p-6 mb-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="flex items-center gap-2 text-[#33C5E0] border border-[#33C5E03D] px-4 py-2 rounded-[24px] text-[14px] hover:bg-[#33C5E0] hover:text-[#161E22]" onClick={handleEditLegal}>
                <Image src="/assets/icons/edit.svg" alt="edit" width={16} height={16} />
                Edit Legal
              </button>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-6">
                ...
                {data.trustees.map((t, idx) => (
                  <div key={idx} className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 mb-2 text-[#33C5E0]">
                    <span>{t.name}</span>
                    <span>{t.phone}</span>
                    <span>{t.email}</span>
                  </div>
          ...
          <div className="bg-[#161E22] border border-[#232B36] rounded-[18px] p-6 mb-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="flex items-center gap-2 text-[#33C5E0] border border-[#33C5E03D] px-4 py-2 rounded-[24px] text-[14px] hover:bg-[#33C5E0] hover:text-[#161E22]" onClick={handleEditNotes}>
                <Image src="/assets/icons/edit.svg" alt="edit" width={16} height={16} />
                Edit Notes
              </button>
            </div>
