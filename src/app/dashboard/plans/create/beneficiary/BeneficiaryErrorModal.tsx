...
const BeneficiaryErrorModal: React.FC<BeneficiaryErrorModalProps> = ({
  open,
  onCancel,
  onRetry,
}) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#161E22]/80">
      <div className="bg-[#161E22] rounded-[32px] shadow-lg p-8 w-[95vw] max-w-[540px] flex flex-col items-center justify-center border border-[#232B36]">
        <h3 className="text-[#FCFFFF] text-[18px] md:text-[22px] font-medium mb-[5rem] text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full mt-[5rem]">
          <button
            className="bg-[#1C252A] text-[#FCFFFF] px-8 py-3 rounded-[24px] font-medium text-[15px] w-full hover:scale-95 duration-500"
            onClick={onCancel}
          >
            Cancel
          </button>
          <button
            className="bg-[#33C5E0] text-[#161E22] px-8 py-3 rounded-[24px] font-medium text-[15px] w-full hover:scale-95 duration-500"
            onClick={onRetry}
          >
            Try Again
          </button>
