...
interface InactivitySuccessModalProps {
  onCancel: () => void;
  onContinue: () => void;
}

const InactivitySuccessModal: React.FC<InactivitySuccessModalProps> = ({ onCancel, onContinue }) => (
    ...
    <div className="relative flex flex-col items-center justify-between h-auto min-h-[400px] w-full max-w-2xl mx-4 md:mx-0 rounded-[24px] bg-[#161E22] border border-[#2A3338] p-8 md:p-12 shadow-xl gap-8">
      <div className="text-center w-full">
        <span className="text-[16px] md:text-[18px] text-[#FCFFFF] font-normal">
          Inactivity settings saved <span className="text-[#19C37D] font-bold">successfully</span>
        </span>
      </div>
      <div className="flex items-center justify-center w-full">
        <div className="relative flex items-center justify-center">
          ...
          <span className="flex items-center justify-center w-[120px] h-[120px] rounded-full z-10 bg-[#19C37D]">
            <Image
...
export default InactivitySuccessModal;
