...
const UserVerificationTable: React.FC<Props> = ({ users }) => (
          ...
          >
            ...
            <td className="py-4 px-2">
              <div className="flex gap-2">
                <button className="bg-[#33C5E014] border border-[#33C5E03D] text-[#BFC6C8] px-5 py-2 rounded-[16px] text-[12px] font-medium hover:bg-[#232B2F]/80">
                  REJECT
                </button>
