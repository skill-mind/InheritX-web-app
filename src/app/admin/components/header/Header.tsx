    ...
    <section className="sticky top-0 z-50 w-full bg-[#161E22]/80 backdrop-blur-md  flex justify-center border-b border-[#1C252A] h-[92px] md:h-[124px]">
      <header className="w-full max-w-[110rem] mx-auto my-auto h-[60px] flex items-center justify-between px-6 py-4 bg-transparent border-none">
        ...
        <div className="flex items-center justify-between space-x-4 #1C252A">
          {/* Search Bar */}
          <div className="hidden md:flex items-center bg-transparent rounded-[24px] px-[20px] py-[8px] w-[320px] h-[60px] border border-[#2A3338] mr-[4rem]">
          ...
          {/* KYC Verification */}
          <div className="md:flex items-center hidden space-x-4 bg-[#33C5E014] w-[183px] h-[60px] rounded-[24px] px-[20px] py-[8px] border-none ">
            <Image
          ...
          {/* Right side */}
          <div className="flex items-center space-x-2 w-[134px] h-[48px] rounded-l-[24px] rounded-r-[8px] py-[12px] px-[12px] bg-[#1C252A] rounded-x-[24px] rounded-y-[8px] ">
            <Image
            ...
            />
            <span className="text-[#92A5A8] text-[12px] md:text-[14px] font-medium bg-transparent">
              0x231f...5678
            </span>
          </div>

          {/* More */}
          <div className="bg-[#1C252A] h-[48px] w-[48px] md:h-[60px] md:w-[60px] rounded-[8px] flex items-center justify-center">
            <Image
